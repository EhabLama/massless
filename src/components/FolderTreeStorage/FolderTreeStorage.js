    ...
    <div className="folder-tree__storage">
                <div className="folder-tree__storage__box">
                    ...
                    <div className="folder-tree__storage__text-div">
                        <p className="folder-tree__storage__text">{props.type === "drive" ? "Google Drive" : props.type === "mongo" ? "Personal files" : "Amazon S3"}</p>
                    </div>
                </div>
                ...
                <div className="folder-tree__storage__box">
                    <div className="folder-tree__storage__image-div">
                        <img className="folder-tree__storage__image" src={"/images/menu-right.svg"}/>
                    </div>
                    <div className="folder-tree__storage__text-div">
                        <p className="folder-tree__storage__text">{props.type === "drive" ? "Google Drive" : props.type === "mongo" ? "Shared files" : "Amazon S3"}</p>
                    </div>
                </div>
    </div>
